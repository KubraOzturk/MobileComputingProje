...
import com.kubra.instagramclone.Utils.Home.MainActivity;
import com.kubra.instagramclone.Utils.Profile.AccountSettingsActivity;
import com.kubra.instagramclone.Utils.models.Photo;
import com.kubra.instagramclone.Utils.models.User;
import com.kubra.instagramclone.Utils.models.UserAccountSettings;
import com.kubra.instagramclone.Utils.models.UserSettings;
...
//                    Uri firebaseUrl = taskSnapshot.getUploadSessionUri();mStorageReference.child(filePaths.FIREBASE_IMAGE_STORAGE + "/" + user_id + "/photo" + (count + 1))
//                           .getDownloadUrl();
                    Toast.makeText(mContext, "photo upload success", Toast.LENGTH_SHORT).show();

                    //add the new photo to 'photos' node and 'user_photos' node
                 addPhotoToDatabase(caption, mStorageReference.child(filePaths.FIREBASE_IMAGE_STORAGE + "/" + user_id + "/photo" + (count + 1))
        ...
        //case new profile photo
            ...
            uploadTask.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    setProfilePhoto(   mStorageReference.child(filePaths.FIREBASE_IMAGE_STORAGE + "/" + user_id + "/photo" + (count + 1))
                            .getDownloadUrl().toString());
